  ...
  <div :class="['ec-doc-mobile', 'ec-doc-' + shared.docType]">
    <div class="top-bar">
      ...
      <div class="doc-mobile-toolbar">
        <el-button class="open-nav" size="small" @click="showNav">
          <svg role="img" class="icon">
            <use href="/assets/sprite-doc.svg#menu"></use>
          </svg>
        </el-button>
        <Search></Search>
      </div>
...
const pagePathParts = computed(() => {
  let parts = pagePath.value.split('.')
  let items = []
  let link = ''
