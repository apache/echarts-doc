...
+ [Fix] [splitLine]: fix chart throws errors when `splitLine` is enabled in radius axis. [#16736](https://github.com/apache/echarts/issues/16736) ([plainheart](https://github.com/plainheart))
