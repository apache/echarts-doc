...
(dom: HTMLDivElement|HTMLCanvasElement, theme?: Object|string, opts?: {
    ...
    renderer?: string,
    useDirtyRect?: boolean,     // Since `v5.0.0`
    useCoarsePointer?: boolean, // Since `v5.4.0`
    pointerSize?: number,       // Since `v5.4.0`
    ssr?: boolean,              // Since `v5.3.0`
    width?: number|string,
    height?: number|string,
    locale?: string             // Since `v5.0.0`
}) => ECharts
```
